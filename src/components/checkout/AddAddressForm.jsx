      ...
      <form onSubmit={handleSubmit(onSaveAddressHandler)} className="">
        ...
        <div className="flex flex-col gap-4">
          <InputField
            ...
            id="buildingName"
            type="text"
            message="*Flat, House no., Apartment Name is required"
            placeholder="Enter Flat, House no., Apartment Name"
            register={register}
            errors={errors}
          />
        ...
        <button
          disabled={btnLoader}
          className="text-white bg-banner-color5 px-4 py-2 rounded-md mt-4"
          type="submit"
        >
          {btnLoader ? (
            <>
