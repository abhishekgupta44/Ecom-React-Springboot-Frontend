        ...
        <div className="md:w-36 sm:w-24 w-12">
          ...
          <div className="flex items-start gap-5 mt-3">
            <button
              ...
              className="flex items-center font-semibold space-x-2 px-4 py-1 text-xs border border-rose-600 text-gray-800 rounded-md hover:bg-red-500 transition-colors duration-200"
            >
