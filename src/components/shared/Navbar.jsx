...
const Navbar = () => {
  ...
  return (
    <div className="h-[70px] bg-banner-color5 text-white z-50 flex items-center sticky top-0">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        >
          ...
          {user && user.id ? (
            ...
            <li className="font-medium transition-all duration-150 pl-1">
              <Link
                className="flex items-center space-x-2 px-4 py-[6px] 
                            bg-linear-to-r from-red-600 to-orange-500 
                            text-black font-semibold rounded-md shadow-lg 
                            hover:from-gray-500 hover:to-yellow-400 transition 
