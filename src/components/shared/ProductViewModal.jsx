          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <div className="px-6 pt-10 pb-2">
                <DialogTitle
                  as="h1"
                  className="lg:text-3xl sm:text-2xl text-xl font-semibold leading-6 text-gray-900 mb-4"
                >
                  {productName}
                </DialogTitle>
              ...
              <div className="px-6 py-4 flex justify-end gap-4">
                <button
                  ...
                  className="px-4 py-2 text-sm font-semibold text-slate-700 border
                   border-slate-700 hover:text-slate-800 hover:border-slate-800 rounded-md "
                >
                  Close
                </button>
              </div>
